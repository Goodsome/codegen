    ...
    def add_attribute(self, attribute: AttributeSpec) -> Self:
        ...
        for attr in self.attributes:
            if attr.name == attribute.name:
                raise ValueError(f"Attribute '{attribute.name}' already exists in aggregate '{self.name}'")
    ...
    def update_attribute(self, attribute: AttributeSpec) -> Self:
        ...
        for i, attr in enumerate(self.attributes):
            if attr.name == attribute.name:
                ...
                return self
        raise ValueError(f"Attribute '{attribute.name}' not found in aggregate '{self.name}'")
