...
class TypedAsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> TypedAsEdge:
        return TypedAsEdge(
    ...
    @staticmethod
    def to_properties(dto: TypedAsEdge) -> dict[str, Any]:
        return {}
