...
class AcceptsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> AcceptsEdge:
        return AcceptsEdge(
    ...
    @staticmethod
    def to_properties(dto: AcceptsEdge) -> dict[str, Any]:
        return {}
