...
class WritesEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> WritesEdge:
        return WritesEdge(
    ...
    @staticmethod
    def to_properties(dto: WritesEdge) -> dict[str, Any]:
        return {}
