...
class InheritsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> InheritsEdge:
        return InheritsEdge(
    ...
    @staticmethod
    def to_properties(dto: InheritsEdge) -> dict[str, Any]:
        return {}
