...
class ExportsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> ExportsEdge:
        return ExportsEdge(
    ...
    @staticmethod
    def to_properties(dto: ExportsEdge) -> dict[str, Any]:
        return {}
