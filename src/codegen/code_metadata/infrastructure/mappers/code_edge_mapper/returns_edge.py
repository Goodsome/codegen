...
class ReturnsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> ReturnsEdge:
        return ReturnsEdge(
    ...
    @staticmethod
    def to_properties(dto: ReturnsEdge) -> dict[str, Any]:
        return {}
