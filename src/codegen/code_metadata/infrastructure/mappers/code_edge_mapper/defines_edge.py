...
class DefinesEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> DefinesEdge:
        return DefinesEdge(
    ...
    @staticmethod
    def to_properties(dto: DefinesEdge) -> dict[str, Any]:
        return {}
