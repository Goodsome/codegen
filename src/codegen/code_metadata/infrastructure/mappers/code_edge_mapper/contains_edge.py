...
class ContainsEdgeMapper(BaseEdgeMapper):
    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> ContainsEdge:
        return ContainsEdge(
    ...
    @staticmethod
    def to_properties(dto: ContainsEdge) -> dict[str, Any]:
        return {}
