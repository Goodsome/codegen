...
from codegen.code_metadata.application.dtos.code_node_dto import FunctionNodeDto
...
class FunctionNodeMapper:
    ...
    @classmethod
    def to_domain(cls, orm_model: CodeNodeModel) -> FunctionNode:
    ...
    @classmethod
    def to_dto(cls, orm_model: CodeNodeModel) -> FunctionNodeDto:
    ...
    @classmethod
    def to_orm(cls, domain_entity: FunctionNode) -> FunctionNodeModel:
