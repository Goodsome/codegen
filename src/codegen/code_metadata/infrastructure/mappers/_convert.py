...
_DOMAIN_BINOP_TO_AST: dict[BinOp, ast.operator] = {v: k() for k, v in _AST_BINOP_TO_DOMAIN.items()}
...
_DOMAIN_BOOLOP_TO_AST: dict[BoolOp, ast.boolop] = {v: k() for k, v in _AST_BOOLOP_TO_DOMAIN.items()}
...
_DOMAIN_UNARYOP_TO_AST: dict[UnaryOp, ast.unaryop] = {v: k() for k, v in _AST_UNARYOP_TO_DOMAIN.items()}
...
_DOMAIN_CMPOP_TO_AST: dict[CmpOp, ast.cmpop] = {v: k() for k, v in _AST_CMPOP_TO_DOMAIN.items()}
...
_DOMAIN_CTX_TO_AST: dict[ExprContext, ast.expr_context] = {v: k() for k, v in _AST_CTX_TO_DOMAIN.items()}
