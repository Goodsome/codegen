...
from codegen.code_metadata.domain.aggregates import ExternalModule
...
class SyncProjectContext:
    ...
    def sync_parsed_modules(
        ...
        for parsed_module in parsed_modules:
            module = self.sync_parsed_module(
    ...
    def find_module(self, path: str) -> Module | None:
        ...
        # if module is None and not path.startswith("codegen"):
        # module = self.registry.create_external_module(path=path)
        # self.sync_modules[module.id] = module
        return module
