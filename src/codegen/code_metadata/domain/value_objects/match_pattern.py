...
from codegen.code_metadata.domain.enums.ast_match_pattern_kind import AstMatchPatternKind
...
class MatchSingleton(ValueObject):
    ...
    kind: Literal[AstMatchPatternKind.MATCH_SINGLETON] = AstMatchPatternKind.MATCH_SINGLETON
...
class MatchSequence(ValueObject):
    ...
    kind: Literal[AstMatchPatternKind.MATCH_SEQUENCE] = AstMatchPatternKind.MATCH_SEQUENCE
