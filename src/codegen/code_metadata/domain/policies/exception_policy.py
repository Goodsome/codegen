...
class ExceptionPolicy(ComponentPolicy):
    component_type: ClassVar[ComponentType] = ComponentType.EXCEPTION
    dir_name: ClassVar[ComponentDir] = ComponentDir.EXCEPTIONS
