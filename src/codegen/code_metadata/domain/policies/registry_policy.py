...
class RegistryPolicy(ComponentPolicy):
    component_type: ClassVar[ComponentType] = ComponentType.REGISTRY
    dir_name: ClassVar[ComponentDir] = ComponentDir.REGISTRIES
