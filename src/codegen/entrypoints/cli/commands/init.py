...
def init(
    ...
    Examples:
        $ codegen init
        $ codegen init -c custom_blueprint.yaml
    """
    config_file_path = Path(config_file)
    
    if config_file_path.exists():
        console.print(f"[bold red]Error:[/] The file [yellow]{config_file}[/] already exists. Initialization aborted.", style="red")
    ...
    console.print(f"[bold green]Success:[/] Initialized a new project blueprint at [yellow]{config_file}[/]")
